...
public class RandomUserAgent {
    ...
    private static Map<String, Double> frequencyMap = new HashMap<>();

    static {

        frequencyMap.put("Internet Explorer", 11.8);
        frequencyMap.put("Firefox", 28.2);
        frequencyMap.put("Chrome", 52.9);
        frequencyMap.put("Safari", 3.9);
        frequencyMap.put("Opera", 1.8);

        userAgentsMap.put("Internet Explorer", new String[] {
        ...
        userAgentsMap.put("Firefox", new String[] {
        ...
        userAgentsMap.put("Chrome", new String[] {
        ...
        userAgentsMap.put("Safari", new String[] {
        ...
        userAgentsMap.put("Opera", new String[] {
    ...
    public static String getRandomUserAgent() {
        ...
        String browser = null;
        double count = 0.0;
        for(Map.Entry<String, Double> freq : frequencyMap.entrySet()) {
            count += freq.getValue();
            if(rand <= count) {
                browser = freq.getKey();
                break;
        ...
        String userAgents[] = userAgentsMap.get(browser);
