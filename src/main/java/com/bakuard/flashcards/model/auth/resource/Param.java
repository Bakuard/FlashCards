 ...
 * доступ для разных пользователей или свойство некотрого пользователя
 * ({@link com.bakuard.flashcards.model.auth.credential.Principal}), который запрашивает доступ к некоторому
 * ресурсу. Каждое свойство представленно в виде пары ключ-значение.
 * @param key наименоване свойства.
