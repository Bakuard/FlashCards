...
public class Params {
    ...
    /**
     * Находит и возвращает первое своство имеющее заданный ключ. Если нет свойства с таким ключом -
     ...
     * @param key ключ значений искомых свойств.
     * @param type тип, к котрому преобразуются возвращаемые значения искомых свойств.
     * @return значения всех свойств имеющих заданный ключ.
     ...
     * может использоваться для создания разных и независмых(с точки зрения разделяемых данных) списков свойств.
     */
    public static class Builder {
        ...
        /**
         * Ищет первое свойтсво имеющее такой же ключ, как у задаваемого свойства. Если такое свойство
        ...
        /**
         * Ищет первое свойтсво имеющее указанный ключ. Если такое свойство есть - заменяет его на
