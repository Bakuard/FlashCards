...
public class PermissionDeniedException extends RuntimeException {
    ...
    /**
     * Возвращает описание действия на ресурсом, в выполнении которого было отказано пользователю.
     * @return описание действия на ресурсом, в выполнении которого было отказано пользователю.
     */
     ...
     * может использоваться для создания разных и независмых(с точки зрения разделяемых данных) объектов исключений.
     */
    public static class Builder {
        ...
        /**
         * Устанавливает сообщение об ошибке сгенерированнео на основе параметров запроса.
         * @param request (см {@link AuthRequest}).
         * @return ссылку на этот же объект.
         */
